...
Consider analysing the main effect of treatment without conditioning on treatment duration if necessary. I'll let you figure out how to do it. Hint: copy the code block above and change the filter.