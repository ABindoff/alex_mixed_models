...
Comparing the (definitely incorrect) ANOVA $m_1$ with the mixed effects model $m_2$ -  
...
As a further comparison, we estimate means and confidence intervals from $m_1$ and $m_2$ by making predictions which incorporate model uncertainty. This is straightforward for $m_1$, but for the mixed model we need to employ bootstrapping.
