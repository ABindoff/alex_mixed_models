...
As a further comparison, we estimate means and confidence intervals from $m_1$ and $m_2$ by making predictions which incorporate model uncertainty. This is straightforward for $m_1$, but for the mixed model we need to employ bootstrapping. If you're running this analysis on your computer it might take a couple of minutes to run.
